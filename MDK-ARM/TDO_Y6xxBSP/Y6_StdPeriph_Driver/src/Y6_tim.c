...
/**
  ...
  * @param  TIMx: where x can be 1, 4, 15, 16 and 17 to select the TIM peripheral.
  * @retval None
  *   
  */
void TIM_Reset(TIM_TypeDef* TIMx)
{
  ...
  if (TIMx == TIM1)
  {
		RCC_SetPRESETCTRL(1<<PRESET_BIT_TIM1, DISABLE);
    RCC_SetPRESETCTRL(1<<PRESET_BIT_TIM1, ENABLE);
  }     
  else if (TIMx == TIM4)
  {
		RCC_SetPRESETCTRL(1<<PRESET_BIT_TIM4, DISABLE);
    RCC_SetPRESETCTRL(1<<PRESET_BIT_TIM4, ENABLE);
  }
  else if (TIMx == TIM15)
  {
		RCC_SetPRESETCTRL(1<<PRESET_BIT_TIM15, DISABLE);
    RCC_SetPRESETCTRL(1<<PRESET_BIT_TIM15, ENABLE);
  } 
  else if (TIMx == TIM16)
  {
		RCC_SetPRESETCTRL(1<<PRESET_BIT_TIM16, DISABLE);
    RCC_SetPRESETCTRL(1<<PRESET_BIT_TIM16, ENABLE);
  } 
  else
  {
    if (TIMx == TIM17)
    {
			RCC_SetPRESETCTRL(1<<PRESET_BIT_TIM17, DISABLE);
      RCC_SetPRESETCTRL(1<<PRESET_BIT_TIM17, ENABLE);
    }  
  }
...
/**
  ...
  * @param  TIMx: where x can be 1, 4, 15, 16 and 17 to select the TIM 
  *         peripheral.
...
/**
  ...
  * @param  TIMx: where x can be 1, or 4 to select the TIM peripheral.
...
/**
  ...
  * @param  TIMx: where x can be 1, 4, 15, 16 and 17to select the TIMx
  *         peripheral.
...
/**
  ...
  *         parameters in the TIM_OCInitStruct.
  * @param  TIMx: where x can be 1, 4 or 15 to select the TIM peripheral.
  * @param  TIM_OCInitStruct: pointer to a TIM_OCInitTypeDef structure
  *         that contains the configuration information for the specified TIM 
  *         peripheral.
  * @retval None
...
/**
  ...
  * @param  TIMx: where x can be 1, 4 or 15 to select the TIM 
  *   peripheral.
  * @param  TIM_ForcedAction: specifies the forced Action to be set to the output waveform.
  *   This parameter can be one of the following values:
...
/**
  ...
  * @param  TIMx: where x can be 1, 4 and 15 to select the TIM peripheral.
  * @param  TIM_OCPreload: new state of the TIMx peripheral Preload register
  *   This parameter can be one of the following values:
  *     @arg TIM_OCPreload_Enable
  *     @arg TIM_OCPreload_Disable
...
/**
  ...
  * @param  TIMx: where x can be 1, 4, 15, 16 or 17 to select the TIM peripheral.
...
/**
  ...
  * @param  TIMx: where x can be 1, 4, 15, 16 or 17 to select the TIMx peripheral.
  ...
  *   - TIM16 and TIM17 can have TIM_IT_Update or TIM_IT_CC1.   
  *   - TIM_IT_Break is used only with TIM1 and TIM15, TIM16, TIM17
...
/**
  ...
  * @param  TIMx: where x can be 1, 4, 15, 16 or 17 to select the 
  *         TIM peripheral.
...
/**
  ...
  *     TIM_FLAG_Trigger. 
  *   - TIM_FLAG_Break is used only with TIM1 and TIM15, TIM16, TIM17
...
/**
  ...
  *   - TIM15 can have only TIM_FLAG_Update, TIM_FLAG_CC1,TIM_FLAG_CC2 or
  *     TIM_FLAG_Trigger. 
  *   - TIM16 and TIM17 can have TIM_FLAG_Update or TIM_FLAG_CC1.
  *   - TIM_FLAG_Break is used only with TIM1 and TIM15, TIM16, TIM17
  *   - TIM_FLAG_COM is used only with TIM1, TIM15, TIM16 and TIM17.
  * @retval None
  */
